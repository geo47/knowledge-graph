...
class IndianGenderPredictor(object):
    ...
    def _get_input_files(self):
        data_path = "data/"  #Path(__file__).parent / Path("data")

        return {
            'male': '/home/muzamil/Projects/Python/ML/NLP/KG/knowledge-graph/data/kb/gender/Indian-Female-Names.csv', #data_path + "Indian-Male-Names.csv", #/ Path('Indian-Male-Names.csv'),
            'female': '/home/muzamil/Projects/Python/ML/NLP/KG/knowledge-graph/data/kb/gender/Indian-Male-Names.csv' #data_path + "Indian-Female-Names.csv" #/ Path('Indian-Female-Names.csv')
        }
