...
def main():
    ...
    for file in pickles:
        ...
        entities['curry'] = 'Menu'
        entities['Deep-flavored curry'] = 'Menu'
        entities['salmon dishes'] = 'Menu'
        entities['udon'] = 'Menu'
        ...
        final_list = []
        curr_dir = os.getcwd()
        # file_name_list = file.split('/')[-1].split('.')[0].split('_')[1:]
        ...
        df = pd.read_csv(curr_dir +"/data/output/kg/input_data.txt-out.csv")
